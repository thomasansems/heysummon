interface HeySummonIconProps {
  className?: string;
  size?: number;
}

/**
 * HeySummon lobster claw icon (inline SVG).
 * Uses hardcoded gradient colors so it works everywhere without CSS variables.
 */
export function HeySummonIcon({ className = "", size = 28 }: HeySummonIconProps) {
  return (
    <svg
      viewBox="0 0 120 120"
      fill="none"
    ...
    >
      ...
      <defs>
        <linearGradient id="hs-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#e8472a" />
