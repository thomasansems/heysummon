    ...
    >
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-8 text-sm text-text-body">
          <a href="#experts" className="hover:text-text-heading transition-colors">Experts</a>
        ...
        <div className="flex items-center gap-3">
          <a href="https://cloud.heysummon.ai" target="_blank" rel="noopener noreferrer" onClick={() => trackWaitlistClick('navbar')} className="bg-white text-bg-deep px-4 py-2 rounded-full text-sm font-semibold hover:bg-text-heading transition-colors">
            Join Waiting List
          </a>
          <button
      ...
      <AnimatePresence>
        {mobileOpen && (
          ...
          >
            <a href="#experts" onClick={() => setMobileOpen(false)} className="hover:text-text-heading transition-colors px-3 py-2">Experts</a>
