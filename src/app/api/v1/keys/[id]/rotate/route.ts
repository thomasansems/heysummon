...
import { generateDeviceSecret, hashDeviceToken, getHmacSecret } from "@/lib/api-key-auth";
...
export async function POST(
  ...
  const previousKeyHash = crypto.createHmac("sha256", getHmacSecret()).update(key.key).digest("hex");
