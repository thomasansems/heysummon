...
- Signs every validated request with Ed25519 — platform rejects anything that bypassed Guard
- Blocks requests containing sensitive data (credit cards, SSNs/BSNs)
