...
const options = [
  {
    icon: Link,
    title: 'Option A: Get a link from your provider',
    description:
      'Your provider shares a setup link with you. Open it, review the summoning guidelines and context instructions, and you are connected. The link tells your AI when and how to summon the expert.',
  },
  {
    icon: Terminal,
    title: 'Option B: Install the skill via npm',
    description:
      'Run npx skill.sh heysummon and it will guide you through the process of connecting to a provider. You will be prompted to enter the provider URL and verify the connection.',
  },
];
