  ...
  return (
    <div>
      <div className="mb-6 flex items-center gap-3">
        <button onClick={() => router.push("/dashboard/providers")} className="text-sm text-muted-foreground hover:text-foreground">
          ← Providers
        </button>
        <h1 className="text-2xl font-semibold text-foreground">{provider.name} — Settings</h1>
      </div>
