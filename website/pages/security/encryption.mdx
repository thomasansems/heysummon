...
| Expert signing private key | Expert device only | Expert only |
| Expert encryption private key | Expert device only | Expert only |
...
```json
{
  ...
  "expertSignPubKey": "MCo...hex-encoded-Ed25519-pubkey...",
  "expertEncryptPubKey": "MCo...hex-encoded-X25519-pubkey..."
}
```
