...
interface StepVerifyProviderProps {
  providerId: string;
  providerKey: string;
...
export function StepVerifyProvider({
  providerId,
  providerKey,
  channel,
  onVerified,
}: StepVerifyProviderProps) {
  ...
  return (
    <div>
      ...
      {channel === "telegram" ? (
        ...
        <div className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Install the HeySummon provider skill in your OpenClaw agent and configure
            it with your provider key.
          </p>
