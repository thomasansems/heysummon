...
```
Consumer                    Platform (blind relay)              Expert

Generate Ed25519 keypair
Generate X25519 keypair
         │
         │  POST /api/v1/help
         │  { signPublicKey, encryptPublicKey, question }
         ├──────────────────────────────▶
         │                                        ──notification──▶
         │                                                      Generate keypairs
         │                              ◀── POST /key-exchange ──
         ...
         │
         │  Both sides derive shared secret via X25519 DH
         │  Messages encrypted with AES-256-GCM, signed with Ed25519
         │
...
After submitting, the expert performs key exchange:
