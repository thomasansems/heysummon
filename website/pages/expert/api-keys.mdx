...
<Callout type="info">
  IP Security is also configurable per-expert on the **Users** page and per-client on the **Clients** page — directly inline without navigating to a separate settings page.
</Callout>
