            ...
            <>
              ...
              {flags.formLogin && (
                <form onSubmit={mode === "login" ? handleFormLogin : handleRegister} className="mb-0">
                  {mode === "register" && (
                    <>
                      ...
                      <input
                        ...
                        className="mb-3 w-full rounded-md border border-border bg-muted/50 backdrop-blur-sm px-3.5 py-2.5 text-sm text-foreground placeholder:text-muted-foreground outline-none transition-colors focus:border-orange-500 focus:ring-1 focus:ring-orange-500"
                      />
                    </>
                  )}
                  ...
                  <input
                    ...
                    className="mb-4 w-full rounded-md border border-border bg-muted/50 backdrop-blur-sm px-3.5 py-2.5 text-sm text-foreground placeholder:text-muted-foreground outline-none transition-colors focus:border-orange-500 focus:ring-1 focus:ring-orange-500"
                  />
              ...
              {flags.magicLink && flags.formLogin && (
                <button
                  ...
                  disabled={!email}
                  className="mb-3 flex w-full items-center justify-center gap-2 rounded-md border border-border bg-muted/50 backdrop-blur-sm px-4 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-muted disabled:opacity-50"
                >
                ...
                <div className="flex flex-col gap-3">
                  {flags.github && (
                    <button
                      ...
                      className="flex w-full items-center justify-center gap-2 rounded-md bg-black px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-black/90 dark:bg-white dark:text-black dark:hover:bg-white/90"
                    >
                  ...
                  {flags.google && (
                    <button
                      ...
                      className="flex w-full items-center justify-center gap-2 rounded-md border border-border bg-muted/50 backdrop-blur-sm px-4 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-muted"
                    >
