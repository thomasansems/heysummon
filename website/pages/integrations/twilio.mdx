...
<Callout type="info">
These credentials are on the **project dashboard**, not in User Settings. If you're on the User Settings page, click **Twilio Home** in the top-left to go back to the dashboard first.
</Callout>
...
Your Auth Token is a secret. Never commit it to source code or share it publicly. HeySummon stores it encrypted at rest.
</Callout>
...
1. Go to **Experts** and open an expert
