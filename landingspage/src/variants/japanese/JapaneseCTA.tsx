...
export function JapaneseCTA() {
  return (
    <section className="py-32 px-8">
      ...
      >
        {/* Brush-stroke border frame */}
        <div className="brush-border rounded-2xl p-12">
          <h2 className="text-4xl md:text-5xl mb-6">
            We're self-hosted because we need you.
          </h2>
          <p className="text-lg text-[#c4b5a0] mb-8 max-w-2xl mx-auto">
          ...
          >
            {needs.map((need) => (
              <span key={need} className="px-4 py-2 rounded-full bg-[#252540]/50 border border-[#f59e0b]/20 text-sm text-[#c4b5a0]">
                {need}
              </span>
            ))}
          </motion.div>
          ...
          >
            <a
              ...
              className="btn-crimson px-6 py-3 rounded-full font-semibold flex items-center gap-2"
            >
            ...
            <a
              ...
              className="bg-transparent border border-[#f59e0b]/30 text-[#faf5ef] px-6 py-3 rounded-full font-medium hover:bg-[#f59e0b]/5 transition-colors"
            >
              Join Waiting List
            </a>
          </motion.div>
